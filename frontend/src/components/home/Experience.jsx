  ...
  return (
    ...
    >
      <div
        ...
        style={{
          background: `radial-gradient(ellipse at 20% 20%, rgba(234, 179, 8, 0.08), transparent 65%)`,
        }}
      />
      <div
        ...
        style={{
          ...
          background: `radial-gradient(circle at var(--mouse-x) var(--mouse-y), rgba(234, 179, 8, 0.2), transparent 65%)`,
        }}
      />
      ...
      <div
        ...
        style={{ background: `linear-gradient(to right, rgba(234, 179, 8, 0.8), transparent)` }}
      />
    </div>
  );
};
  ...
  const stats = [
    {
      ...
      title: '3+ Años',
      description:
        'De trayectoria sólida liderando la importación de vehículos premium en Costa Rica.',
    },
    {
      icon: <CheckCircle className="experience-icon" />,
      title: '160+ Vehículos',
      description:
        'Importaciones exitosas garantizando un proceso seguro, eficiente y transparente.',
    },
    {
    ...
    },
    {
      ...
      description:
        'Oficinas físicas en Heredia y Puntarenas para brindarle seguridad jurídica y cercanía.',
    },
  ];
      ...
      <div className="container">
        <div className="experience-header">
          ...
          <p className="experience-subtitle">
            Importadora SAVS nace de la pasión por los autos y el compromiso con el servicio
            excepcional. En solo 3 años, nos hemos convertido en el referente de importación premium
            en Costa Rica, facilitando el sueño de más de 160 familias con transparencia absoluta y
            el respaldo de nuestras sedes físicas en Heredia y Puntarenas.
          </p>
        </div>
        ...
        <div className="trust-banner">
          ...
          <div className="trust-image-placeholder">
            <img src={showroomImg} alt="Importadora SAVS Showroom" className="trust-img" />
