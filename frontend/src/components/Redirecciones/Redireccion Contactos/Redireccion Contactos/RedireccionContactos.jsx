...
const RedireccionContactos = () => {
  const { formData, loading, handleChange, sendEmail, setFormData } =
    useRedireccionContactosLogica();
  ...
  const defaultBranches = [
    {
      ...
      map_embed:
        'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3929.5855260026214!2d-84.16194218520268!3d9.98198589286378!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8fa0fb060411b931%3A0xeab308c10b981!2sBoulevard+Cariari!5e0!3m2!1ses!2scr!4v1711200000000',
    },
    {
      id: 'puntarenas',
      ...
      schedule: 'L-V: 8:00 AM - 5:00 PM',
      map_embed:
        'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3930.2225!2d-84.7666!3d9.9850!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8fa01bd!2sPuntarenas!5e0!3m2!1ses!2scr!4v1711200000000',
    },
  ];

  const branchHeredia = (branches.length > 0 ? branches : defaultBranches).find(
    (b) => b.id === 'heredia'
  );
  const branchPuntarenas = (branches.length > 0 ? branches : defaultBranches).find(
    (b) => b.id === 'puntarenas'
  );
    ...
    <div className="paginaContacto">
      ...
      <header className="headerContacto">
        <div className="headerInfo">
          ...
          <p>
            Expertos en importación directa. Tu próximo vehículo de alta gama está a un mensaje de
            distancia.
          </p>
        </div>
      ...
      <section className="contenidoContacto" style={{ gap: '20px', paddingBottom: '100px' }}>
          ...
          {initialVehicle && (
            ...
            >
              ...
              <div>
                ...
                <p style={{ margin: 0, fontSize: '1.2rem', color: '#fff', fontWeight: 700 }}>
                  {initialVehicle.name}
                </p>
              </div>
            </div>
        ...
        <div
          className="infoContacto"
          style={{ flex: '1.5', display: 'flex', flexDirection: 'column', gap: '20px' }}
        >
          <div
            ...
            {(branches.length > 0 ? branches : defaultBranches).map((branch) => (
              <div
                ...
                style={{
                  ...
                  background:
                    activeMap === branch.id ? 'rgba(234, 179, 8, 0.05)' : 'rgba(255,255,255,0.02)',
                  borderRadius: '12px',
                }}
              >
                <h3
          ...
          >
            {(() => {
              const activeBranch =
                (branches.length > 0 ? branches : defaultBranches).find(
                  (b) => b.id === activeMap
                ) || (branches.length > 0 ? branches[0] : defaultBranches[0]);
              return (
                <iframe
