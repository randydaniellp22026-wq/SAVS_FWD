  ...
  return (
    <footer className="footer-savs">
      <div className="footer-top">
        ...
        <div className="footer-col-left">
          ...
          <div className="footer-social-top">
            <a
              href="https://www.facebook.com/p/Importadora-De-Veh%C3%ADculos-SAVS-100083511271381/"
              target="_blank"
        ...
        <div className="footer-col-mid">
          ...
          <ul className="footer-links">
            ...
            <li>
              <Link to="/inventory">Catálogo</Link>
            </li>
            <li>
              <Link to="/perfil">Mi Perfil</Link>
            </li>
            <li>
              <Link to="/vender-auto">Auto como parte de pago</Link>
            </li>
            <li>
        ...
        <div className="footer-col-right">
          ...
          <ul className="footer-contact-info">
            <li>
              <Mail size={18} /> {company.main_email}
            </li>
            <li>
              <MapPin size={18} /> Heredia & Puntarenas
            </li>
            <li>
              <Phone size={18} /> {company.main_phone}
            </li>
            <li>
              <Clock size={18} /> Lun-Sáb: 8:00 AM - 6:00 PM
            </li>
          </ul>
        </div>
        ...
        <div className="footer-col-img">
          <img
            src={
              company.footer_car_img ||
              'https://importadorasavs.com/wp-content/uploads/2025/03/hyundai-2013-ix-1.png'
            }
            alt="Vehículo SAVS"
      ...
      <div className="footer-bottom">
        <p>
          Copyright © {new Date().getFullYear()}. All rights reserved. Powered by Grid Studio Costa
          Rica.
        </p>
