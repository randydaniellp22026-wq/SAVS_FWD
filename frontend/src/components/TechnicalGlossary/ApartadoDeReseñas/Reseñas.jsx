...
const Reseñas = () => {
  ...
  const filteredReviews =
    activeFilter === 'Todos' ? reviews : reviews.filter((rev) => rev.category === activeFilter);
  ...
  return (
    <section className="reviews-section">
      <div className="reviews-header">
        ...
        <p>
          Nuestra reputación se basa en la satisfacción de quienes confían en nosotros. Gestiona y
          visualiza las experiencias de nuestra comunidad.
        </p>
  ...
  return (
    <div className="review-card">
      ...
      <div className="rating-stars">
        {[...Array(5)].map((_, i) => (
          <span key={i} style={{ color: i < review.rating ? '#f5b400' : '#333' }}>
            ★
          </span>
        ))}
      </div>
