    ...
    <div className="admin-container tradein-mgmt">
      ...
      <div className="dashboard-stats-grid" style={{ marginBottom: '2rem' }}>
        ...
        <div className="stat-card">
          ...
          <div className="stat-number">
            {requests.filter((r) => r.estado === 'aprobado').length}
          </div>
        </div>
      </div>
      ...
      <div className="vender-auto-layout">
              ...
              {filteredRequests.map((req) => {
                ...
                return (
                  <div
                    ...
                    style={{
                      cursor: 'pointer',
                      border: selectedReq?.id === req.id ? '1px solid #eab308' : '',
                    }}
                  ...
                  >
                    ...
                    <div className="item-details">
                      <h4 className="item-name">
                        {req.marca} {req.modelo} ({req.anio})
                      </h4>
                      <p className="item-meta" style={{ fontSize: '0.8rem', marginTop: '2px' }}>
                        {req.nombre}
                      </p>
                      <span
                        ...
                        style={{
                          marginTop: '6px',
                          background: STATUS_CONFIG[req.estado]?.bg,
                          color: STATUS_CONFIG[req.estado]?.color,
                          padding: '2px 8px',
                          fontSize: '0.7rem',
                        }}
                      >
        ...
        <div
          className="vender-auto-form-section card-base"
          style={{ flex: '2 1 500px', minHeight: '500px' }}
        >
          {selectedReq ? (
            <div className="tradein-detail-panel animation-fade-in">
              ...
              >
                <div>
                  <h2 style={{ color: '#fff', fontSize: '1.5rem', margin: '0 0 0.5rem 0' }}>
                    {selectedReq.marca} {selectedReq.modelo}{' '}
                    <span style={{ color: '#eab308' }}>{selectedReq.anio}</span>
                  </h2>
                  <p
                    style={{
                      color: '#9ca3af',
                ...
                <div style={{ textAlign: 'right' }}>
                  <span
                    className="admin-status-badge"
                    style={{
                      background: STATUS_CONFIG[selectedReq.estado]?.bg,
                      color: STATUS_CONFIG[selectedReq.estado]?.color,
                      fontSize: '0.9rem',
                      padding: '6px 14px',
                    }}
                  >
              ...
              >
                <div>
                  ...
                  <p style={{ color: '#fff', margin: '0 0 4px 0' }}>
                    <strong>Nombre:</strong> {selectedReq.nombre}
                  </p>
                  <p style={{ color: '#fff', margin: '0 0 4px 0' }}>
                    <strong>Email:</strong> {selectedReq.email}
                  </p>
                  <p style={{ color: '#fff', margin: '0 0 4px 0' }}>
                    <strong>Teléfono:</strong> {selectedReq.telefono}
                  </p>
                </div>
                <div>
                  <h4
                  ...
                  <p style={{ color: '#fff', margin: '0 0 4px 0' }}>
                    <strong>Kilometraje:</strong> {selectedReq.kilometraje} km
                  </p>
                  <p style={{ color: '#fff', margin: '0 0 4px 0' }}>
                    <strong>Transmisión:</strong> {selectedReq.transmision}
                  </p>
                  <p style={{ color: '#eab308', margin: '0 0 4px 0', fontWeight: 'bold' }}>
                    <strong>Precio Esperado:</strong> $
                    {selectedReq.precio_esperado?.toLocaleString()}
                  </p>
                </div>
              </div>
